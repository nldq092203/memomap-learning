...
import { BookOpen, Headphones, Mic, PenTool, Sparkles } from "lucide-react"
              ...
              <div className="grid gap-3">
                {availableSections.map((section) => (
                  <Button
                    ...
                    variant="outline"
                    disabled={loading}
                    className="h-auto justify-start rounded-[22px] border-slate-200 px-4 py-4 text-left text-slate-700 hover:border-emerald-200 hover:bg-emerald-50"
