...
CO_AB_SPECS: tuple[ExerciseSpec, ...] = (
    ExerciseSpec("CO", "tp-01", "Partie A - Activité 1", (18, 19), 1, "A", (10,), ("c", "b", "a", "b", "c", "a", "b"), "Pourquoi les jeunes", "F. Écoutez"),
    ExerciseSpec("CO", "tp-02", "Partie A - Activité 2", (20,), 2, "A", (11,), ("c", "b", "c", "c", "b", "a", "a"), "Marion et Manon", None),
    ExerciseSpec("CO", "tp-03", "Partie A - Activité 3", (21,), 3, "A", (12,), ("b", "c", "b", "c", "c", "a", "b"), "À la suite", None),
    ExerciseSpec("CO", "tp-04", "Partie A - Activité 4", (22,), 4, "A", (13,), ("b", "a", "b", "c", "c", "b", "c"), "Pourquoi, selon", None),
    ExerciseSpec("CO", "tp-05", "Partie A - Activité 5", (23,), 5, "A", (14,), ("c", "c", "a", "a", "a", "a", "a"), "Comment Marie", None),
    ExerciseSpec("CO", "tp-06", "Partie A - Activité 6", (24,), 6, "A", (15,), ("a", "b", "c", "b", "b", "c", "c"), "Qu’est-ce qui a principalement", None),
    ExerciseSpec("CO", "tp-07", "Partie A - Activité 7", (25,), 7, "A", (16,), ("b", "c", "c", "a", "b", "c", "c"), "Pour la philosophe", None),
    ExerciseSpec("CO", "tp-08", "Partie A - Activité 8", (26,), 8, "A", (17,), ("a", "a", "b", "c", "b", "c", "b"), "Pour Pierrick", None),
    ExerciseSpec("CO", "tp-09", "Partie B - Activité 1", (29,), 1, "B", (18,), ("b", "c", "a", "b", "a", "b", "a"), "D’après des statistiques", None),
    ExerciseSpec("CO", "tp-10", "Partie B - Activité 2", (30,), 2, "B", (19,), ("b", "a", "a", "c", "a", "a", "c"), "Le but de la compagnie", None),
    ExerciseSpec("CO", "tp-11", "Partie B - Activité 3", (31,), 3, "B", (20,), ("b", "b", "c", "b", "c", "a", "c"), "Quel problème", None),
    ExerciseSpec("CO", "tp-12", "Partie B - Activité 4", (32,), 4, "B", (21,), ("c", "c", "a", "b", "a", "a", "b"), "Qu’est-ce qui caractérise", None),
    ExerciseSpec("CO", "tp-13", "Partie B - Activité 5", (33,), 5, "B", (22,), ("a", "b", "a", "b", "b", "a", "b"), "D’après l’invité", None),
    ExerciseSpec("CO", "tp-14", "Partie B - Activité 6", (34,), 6, "B", (23,), ("a", "c", "c", "c", "c", "b", "a"), "Pourquoi Thomas", None),
    ExerciseSpec("CO", "tp-15", "Partie B - Activité 7", (35,), 7, "B", (24,), ("c", "b", "b", "a", "b", "a", "b"), "Pourquoi, selon", None),
    ExerciseSpec("CO", "tp-16", "Partie B - Activité 8", (36,), 8, "B", (25,), ("a", "a", "b", "b", "b", "a", "c"), "D’après Laura", None),
)

CO_C_SPECS: tuple[ExerciseSpec, ...] = (
    ExerciseSpec("CO", "tp-17", "Partie C - Activité 1", (39,), 1, "C", (26, 27, 28), ("a", "c", "a", "c", "a", "a"), "Sur quel principe", None),
    ExerciseSpec("CO", "tp-18", "Partie C - Activité 2", (40,), 2, "C", (29, 30, 31), ("b", "c", "c", "a", "b", "a"), "Selon Anne", None),
    ExerciseSpec("CO", "tp-19", "Partie C - Activité 3", (41,), 3, "C", (32, 33, 34), ("c", "a", "b", "b", "a", "b"), "Selon le journaliste", None),
    ExerciseSpec("CO", "tp-20", "Partie C - Activité 4", (42,), 4, "C", (35, 36, 37), ("b", "b", "b", "b", "a", "c"), "D’après la journaliste", None),
    ExerciseSpec("CO", "tp-21", "Partie C - Activité 5", (43,), 5, "C", (38, 39, 40), ("c", "c", "c", "c", "c", "b"), "La journaliste", None),
    ExerciseSpec("CO", "tp-22", "Partie C - Activité 6", (44,), 6, "C", (41, 42, 43), ("b", "b", "a", "c", "c", "b"), "D’après Karine", None),
    ExerciseSpec("CO", "tp-23", "Partie C - Activité 7", (45,), 7, "C", (44, 45, 46), ("c", "c", "c", "a", "c", "c"), "D’après Hélène", None),
    ExerciseSpec("CO", "tp-24", "Partie C - Activité 8", (46,), 8, "C", (47, 48, 49), ("b", "a", "a", "a", "a", "b"), "D’après Emmanuel", None),
)
...
def _clean_line(line: str) -> str:
    ...
    line = re.sub(r"[>/\\.\s]*\d(?:[,.]\d)?\s*p(?:oi|œ|ei)nt.*$", "", line, flags=re.IGNORECASE)
    line = re.sub(r"\s+", " ", line)
    return line.strip()
...
def extract_questions(text: str, *, start_marker: str | None, end_marker: str | None) -> list[dict[str, Any]]:
...
def build_paper(spec: ExerciseSpec, doc: fitz.Document) -> dict[str, Any]:
    ...
    content = {
        ...
        "section": spec.section,
        "audio_filename": audio_filename(spec.audio_tracks[0]) if spec.audio_tracks else None,
...
def upsert_paper(content: dict[str, Any], *, dry_run: bool) -> dict[str, Any]:
    ...
    existing = repo.get_by_test_id(content["test_id"], LEVEL, VARIANT, content["section"])
    if existing:
